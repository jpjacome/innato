...
<head>
    ...
    <title>{{ isset($settings) && $settings && isset($settings->dashboard_title) ? $settings->dashboard_title : config('app.name', 'Laravel') }} - Editor Dashboard</title>
...
<body class="control-panel">
    <header class="control-panel-header">
        <div class="control-panel-header-content">
            <div class="control-panel-logo">
                ...
                @else
                    <span class="control-panel-logo-text">{{ isset($settings) && $settings && isset($settings->dashboard_title) ? $settings->dashboard_title : 'Editor Dashboard' }}</span>
                @endif
            </div>
            ...
            <nav class="control-panel-nav">
                ...
                <a href="{{ route('editor.dashboard') }}" class="control-panel-button {{ request()->routeIs('editor.dashboard') ? 'active' : '' }} header-nav-button">Dashboard</a>
                <a href="{{ route('editor.destinations.index') }}" class="control-panel-button {{ request()->routeIs('editor.destinations.*') ? 'active' : '' }} header-nav-button">Destinations</a>
    ...
    <div class="mobile-menu" id="mobile-menu">
        <nav class="mobile-menu-nav">
            ...
            <a href="{{ route('editor.dashboard') }}" class="control-panel-button {{ request()->routeIs('editor.dashboard') ? 'active' : '' }}">Dashboard</a>
            <a href="{{ route('editor.destinations.index') }}" class="control-panel-button {{ request()->routeIs('editor.destinations.*') ? 'active' : '' }}">Destinations</a>
