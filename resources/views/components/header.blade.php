    ...
    <div class="header-bar">
        ...
        <nav class="main-nav fade-in-2">
            <ul class="nav-list">
                ...
                <li><a href="/reviews"><span class="nav-icon ph ph-star"></span><span class="nav-text">{{ $headerSetting->nav_reviews_text }}</span></a></li>
            </ul>
...
<div id="mobile-menu" class="mobile-menu">
    <ul>
        ...
        <li><a href="/reviews">{{ $headerSetting->nav_reviews_text }}</a></li>
    </ul>
</div>
