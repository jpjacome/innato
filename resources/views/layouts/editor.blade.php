...
<head>
    ...
    <title>{{ isset($settings) && $settings && isset($settings->dashboard_title) ? $settings->dashboard_title : config('app.name', 'Laravel') }} - Panel de Editor</title>
    ...
    <header class="control-panel-header">
        <div class="control-panel-header-content">
            <div class="control-panel-logo">
                ...
                @else
                    <span class="control-panel-logo-text">{{ isset($settings) && $settings && isset($settings->dashboard_title) ? $settings->dashboard_title : 'Panel de Editor' }}</span>
                @endif
            </div>
